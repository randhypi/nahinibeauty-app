...
export default function index() {
  return (
    <>
      <div
        className="px-7 font-Poppins grid lg:grid-cols-2 grid-cols-1 pt-20"
        id="banner"
      >
        <div className="py-5 flex flex-col gap-y-1 md:gap-y-4 justify-items-center">
          ...
          <span className="text-white text-md md:text-md leading-lose">
            Aute quis culpa veniam cupidatat esse sit nostrud officia qui enim.
            Enim consequat sit dolore consequat quis eu est do laborum sint
            eiusmod fugiat anim nisi. Reprehenderit culpa minim mollit proident
            ullamco in mollit sit. Excepteur reprehenderit aliqua irure ullamco.
            Sint sint mollit sit et qui adipisicing nostrud. Sint nisi minim
            minim enim sit.
          </span>
